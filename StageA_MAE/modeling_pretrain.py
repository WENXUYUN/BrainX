...
from util.layers import onering_conv_layer_batch,upconv_layer_batch,Get_feature,pool_layer_batch
from util.utils import Get_neighs_order,Get_upconv_index
...
class PretrainVisionTransformer(nn.Module):
    ...
    def forward(self, x, mask):
        #origin = x.detach().cpu().numpy()
        #np.save(f'./results/origin.npy', origin)
        ...
        #np.save(f'./results/recon.npy', recon)
        #sys.exit()
        return x
